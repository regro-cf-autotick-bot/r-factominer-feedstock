...
pixi add r-factominer
# for installing globally
pixi global install r-factominer
```
...
It is possible to list all of the versions of `r-factominer` available on your platform:
...
```
pixi search r-factominer --channel conda-forge
```
